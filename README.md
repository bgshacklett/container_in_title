...
1. **Prereqs**: Node 20+, `pnpm`, and AMO API credentials (https://addons.mozilla.org/developers/addon/api/key/). The extension ID in `manifest.json` is `{220d013f-ca2e-42dc-8438-de3f4cb7b986}`; keep it as-is when signing.
